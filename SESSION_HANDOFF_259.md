...
`PROJECT_COLD_STORAGE.md`. The project has never held a document playing this role.
...
| `40K_Decision_Log.md` | `845695ba68ec` | D356 appended |
...
| `pipeline_manifest.py` | `4a93a487ba3a` | 203 restored; 259 and the cold-storage doc guarded |
