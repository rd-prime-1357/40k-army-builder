...
ARMY_TO_MFM = OrderedDict([
    ("Adeptus Astartes", "MFM_Space_Marines_v1.1.txt"),
    ("Black Templars",   "MFM_Black_Templars_v1.1.txt"),
    ("Blood Angels",     "MFM_Blood_Angels_v1.1.txt"),
    ("Dark Angels",      "MFM_Dark_Angels_v1.1.txt"),
    ("Deathwatch",       "MFM_Death_Watch_v1.1.txt"),
    ("Imperial Fists",   "MFM_Space_Marines_v1.1.txt"),
    ("Iron Hands",       "MFM_Space_Marines_v1.1.txt"),
    ("Raven Guard",      "MFM_Space_Marines_v1.1.txt"),
    ("Salamanders",      "MFM_Space_Marines_v1.1.txt"),
    ("Space Wolves",     "MFM_Space_Wolves_v1.1.txt"),
    ("Ultramarines",     "MFM_Space_Marines_v1.1.txt"),
    ("White Scars",      "MFM_Space_Marines_v1.1.txt"),
    ("Chaos Daemons",    "MFM_Chaos Daemons_v1.1.txt"),
...
MFM_SOURCE_NAME = {
    ...
    "MFM_Chaos Daemons_v1.1.txt":  "Chaos Daemons",
    ...
    "MFM_Drukhari_v1.1.txt": "Drukhari",
}
